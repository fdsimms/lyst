...
/***/ function(module, exports, __webpack_require__) {
	...
	var _groceryList = __webpack_require__(169);
	
	var _groceryList2 = _interopRequireDefault(_groceryList);
	
	var _data2 = __webpack_require__(170);
	
	var _data3 = _interopRequireDefault(_data2);
	
	var _challengeResponses = __webpack_require__(171);
	
	var _challengeResponses2 = _interopRequireDefault(_challengeResponses);
	...
	var App = _react2.default.createClass({
	  ...
	  data: function data() {
	    ...
	    if (this.state.view === "challenge") {
	      returnVal = _challengeResponses2.default;
	    } else if (this.state.view === "classic") {
	      returnVal = _data3.default;
	    } else {
	      returnVal = _groceryList2.default;
	    }
	
	    return returnVal;
	  },
	  challengeButton: function challengeButton() {
	    var classes = "button";
	    var clickHandler;
	    if (this.state.view === "challenge") {
	  ...
	  classicButton: function classicButton() {
	    var classes = "button";
	    var clickHandler;
	  ...
	  groceriesButton: function groceriesButton() {
	    var classes = "button";
	    var clickHandler;
	...
	exports.default = [{
	  ...
	  "sections": [{
	    ...
	    "sections": [{
	      ...
	      "sections": [{
	        id: 1002,
	        name: "The simplicity of the prompt led me towards adopting a minimalist approach to designing my response. When I thought about lists, I immediately imagined a list written on a sheet of paper—a pretty minimalist way of keeping a list in real life. So I wanted to display the list on the page as though it were printed on lined loose-leaf. The borders on the list items, which only appear on the bottom and right sides, accomplish this without cluttering things up too much. The indentation on the left sides gives an easy visual reference to what level of the list we're on: it's just enough to set each level apart, but not so much that the list can't handle a pretty large number of levels before everything is squashed to one side. (Yes, it wouldn't be very pretty if it had to display an actual infinitely nested list, but in that case I would only show a certain number of levels at any given time.)",
	        sections: [{
	          id: 1003,
	          name: "The rest of the design decisions all stemmed from a desire to let the user know what to do without beating them over the head with it. Some other visual cues: the green plus symbols and red minus symbols paired with bold font and on-hover color changes shows the user which items can be clicked on to expand them further. When a list has already been expanded, its font turns gray to reflect its status. Buttons you can't click on are faded, and buttons you can click on get darker when you hover over them.",
	          sections: [{
	            id: 1004,
	            name: "One benefit of the minimalist approach is that the site is pretty responsive. When the width of the main div is too small, some of the list text can spill out if a word is too long, but other than that it pulls off being rather responsive without really trying (kind of like how Oreos are accidentally vegan).",
	            sections: []
	          }]
	        }]
	      }]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = _react2.default.createClass({
	  ...
	  mapPropsListToHTML: function mapPropsListToHTML() {
	    return this.props.list.sections.map(function (item) {
	      return _react2.default.createElement(List, { key: item.id, list: item });
	    });
	  },
	  render: function render() {
	    var children;
	    ...
	    if (this.hasChildren() && this.state.showChildren) {
	      plusOrMinus = _react2.default.createElement("i", { className: "fa fa-minus-square" });
	    } else if (this.hasChildren()) {
	      plusOrMinus = _react2.default.createElement("i", { className: "fa fa-plus-square" });
	    }
